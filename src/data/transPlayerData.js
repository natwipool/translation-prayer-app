const transPrayerData = [{
  ...
  filename: ['01_คำทำวัตรเช้า.ogg', '01_คำทำวัตรเช้า.mp3'],
  lyrics: [
  ...
  category: 'คำทำวัตรเช้า',
  filename: ['02_ตังขณิกปัจจเวกขณปาฐะ.ogg', '02_ตังขณิกปัจจเวกขณปาฐะ.mp3'],
  lyrics: [
  ...
  filename: ['03_คำทำวัตรเย็น.ogg', '03_คำทำวัตรเย็น.mp3'],
  lyrics: [
    'โย โส ภะคะวา อะระหัง สัมมาสัมพุทโธ',
    'พระผู้มีพระภาคเจ้านั้นพระองค์ใด, เป็นพระอรหันต์,',
    'ดับเพลิงกิเลสเพลิงทุกข์สิ้นเชิง, ตรัสรู้ชอบได้โดยพระองค์เอง,',
  ...
  category: 'คำทำวัตรเย็น',
  filename: ['04_อตีตปัจจเวกขณปาฐะ.ogg', '04_อตีตปัจจเวกขณปาฐะ.mp3'],
  lyrics: [
  ...
  filename: ['05_ท๎วัตติงสาการปาฐะ.ogg', '05_ท๎วัตติงสาการปาฐะ.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเช้า',
  filename: ['06_อภิณหปัจจเวกขณปาฐะ.ogg', '06_อภิณหปัจจเวกขณปาฐะ.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเช้า',
  filename: ['07_บทพิจารณาสังขาร.ogg', '07_บทพิจารณาสังขาร.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเช้า',
  filename: ['08_สัพพปัตติทานคาถา.ogg', '08_สัพพปัตติทานคาถา.mp3'],
  lyrics: [
  ...
  precept: 'บทแผ่เมตตา',
  category: 'บทสวดมนต์ภาคเช้า',
  filename: ['09_บทแผ่เมตตา.ogg', '09_บทแผ่เมตตา.mp3'],
  lyrics: [
  ...
  filename: ['10_สรณคมนปาฐะ.ogg', '10_สรณคมนปาฐะ.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเย็น',
  filename: ['11_เขมาเขมสรณคมนปริทีปิกาคาถา.ogg', '11_เขมาเขมสรณคมนปริทีปิกาคาถา.mp3'],
  lyrics: [
  ...
  precept: 'อริยธนคาถา',
  category: 'บทสวดมนต์ภาคเย็น',
  filename: ['12_อริยธนคาถา.ogg', '12_อริยธนคาถา.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเย็น',
  filename: ['13_ติลักขณาทิคาถา.ogg', '13_ติลักขณาทิคาถา.mp3'],
  lyrics: [
  ...
  precept: 'ภารสุตตคาถา',
  category: 'บทสวดมนต์ภาคเย็น',
  filename: ['14_ภารสุตตคาถา.ogg', '14_ภารสุตตคาถา.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเย็น',
  filename: ['15_ภัทเทกรัตตคาถา.ogg', '15_ภัทเทกรัตตคาถา.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเย็น',
  filename: ['16_ธัมมคารวาทิคาถา.ogg', '16_ธัมมคารวาทิคาถา.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเย็น',
  filename: ['17_โอวาทปาฏิโมกขคาถา.ogg', '17_โอวาทปาฏิโมกขคาถา.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเย็น',
  filename: ['18_ปฐมพุทธภาสิตคาถา.ogg', '18_ปฐมพุทธภาสิตคาถา.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเย็น',
  filename: ['19_ปัจฉิมพุทโธวาทปาฐะ.ogg', '19_ปัจฉิมพุทโธวาทปาฐะ.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์ภาคเย็น',
  filename: ['20_อุททิสสนาธิฏฐานคาถา(อิมินา).ogg', '20_อุททิสสนาธิฏฐานคาถา(อิมินา).mp3'],
  lyrics: [
  ...
  filename: ['21_ธัมมจักกัปปวัตตนสุตตปาฐะ.ogg', '21_ธัมมจักกัปปวัตตนสุตตปาฐะ.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์พิเศษ',
  filename: ['22_อริยมรรคมีองค์แปด.ogg', '22_อริยมรรคมีองค์แปด.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์พิเศษ',
  filename: ['23_อานาปานสติสูตร.ogg', '23_อานาปานสติสูตร.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์พิเศษ',
  filename: ['24_ธัมมปหังสนปาฐะ.ogg', '23_อานาปานสติสูตร.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์พิเศษ',
  filename: ['25_ปฏิจจสมุปปาทธัมมะ.ogg', '25_ปฏิจจสมุปปาทธัมมะ.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์พิเศษ',
  filename: ['26_ธาตุปัจจเวกขณปาฐะ.ogg', '26_ธาตุปัจจเวกขณปาฐะ.mp3'],
  lyrics: [
  ...
  category: 'บทสวดมนต์พิเศษ',
  filename: ['27_ปัพพชิตอภิณหปัจจเวกขณปาฐะ.ogg', '27_ปัพพชิตอภิณหปัจจเวกขณปาฐะ.mp3'],
  lyrics: [
